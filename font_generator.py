...
class FontImageGenerator:
    ...
    def __init__(self, width: int, height: int,  
                 font_file: str, letter: str,  
                 output_dir: str, x_position: int = 0, y_position: int=0, noise_level: int = 0,
                 overwrite: bool = False, 
                 all_letters: bool = False, font_size: int = 40):
        self.width = width
        self.height = height
        ...
        if self.all_letters or isinstance(self.letters, list):
            ...
            for letter in letters:
                ...
                if self.x_position == 0 and self.y_position == 0:
                    ...
                    draw.textbbox((self.x_position, self.y_position), letter, font=self.font)
                    draw.text((self.x_position, self.y_position), letter, font=self.font, fill=0)
            ...
            if self.x_position == 0 and self.y_position == 0:
                ...
                self.y_position = self.height // 2
                draw.textbbox((self.x_position, self.y_position), self.letter, font=self.font)
                draw.text((self.x_position, self.y_position), self.letter, font=self.font, fill=0)
                image = self.centerize_letter(image)
            else:
                draw.text((self.x_position, self.y_position), self.letter, font=self.font, fill=0)
                draw.textbbox((self.x_position, self.y_position), self.letter, font=self.font)       
